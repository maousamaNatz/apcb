...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gsap.from("#cs", {
    opacity: 0, // Elemen menjadi sepenuhnya terlihat
    y: -50, // Mengatur posisi y ke 0 sehingga elemen berada di posisi aslinya
    stagger: 0.3, // Menambahkan jeda antar elemen
    duration: 1.5, // Durasi animasi
    ease: "power2.inOut", // Jenis easing untuk animasi
    scrollTrigger: {
      trigger: "#products",
      start: "top bottom", // Mulai animasi ketika bagian atas elemen bertemu bagian bawah viewport
